...
|------------------|-----------|--------|----------|--------|
| Artificial Neural Network (ANN) | 0.862| 0.87 | 0.865 |0.9894|
| Support Vector Machine (SVM)    | 0.861 | 0.86 | 0.864 |0.9813|
| k-Nearest Neighbors (k-NN)      | 0.860 | 0.83 | 0.861 |0.9565|
